    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f_img i) : SV_Target
            {
                ...
                + step(length(tile - float2(0.5, 1)), 0.2) - step(length(tile - float2(0.5, 1)), 0.1)
                + step(length(tile - float2(1, 0.5)), 0.2) - step(length(tile - float2(1, 0.5)), 0.1);
