Shader "Unlit/Electrification"
{
    Properties
    {
        _MainTex ("Texture", 2D) = "white" {}
        [HDR] _NoiseColor("Noise Color", Color) = (1, 1, 1, 1)
        _NoiseTilling("Noise Tilling", Range(0, 50)) = 10
        _NoiseSpeed("Noise Speed", Range(0, 50)) = 10
        _NoiseSize("Noise Size", Range(0, 100)) = 50
    }
    SubShader
    {
